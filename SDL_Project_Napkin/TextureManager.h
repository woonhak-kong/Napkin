...
public:
	...
	void draw(const std::string& id, SDL_Rect src,int destX, int destY, int destW, int destH, double angle = 0, int alpha = 255, bool centered = false, SDL_RendererFlip flip = SDL_FLIP_NONE);
